...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', help="restore checkpoint", default='../raft_output/pwc_tiny_default/raft-sintel.pth')
    ...
    args.fw_output_path = args.path.replace('data/object_test/img', f'object_test_pwc_tiny_output/fw_iter{args.iters}_sintel')
    args.bw_output_path = args.path.replace('data/object_test/img', f'object_test_pwc_tiny_output/bw_iter{args.iters}_sintel')
